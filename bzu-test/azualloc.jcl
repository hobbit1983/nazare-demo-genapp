//AZUALLOC JOB 241901,'ALLOC',NOTIFY=&SYSUID,CLASS=A,MSGCLASS=H,
//       REGION=0M
//*********************************************************************
//* Licensed materials - Property of IBM                              *
//* 5724-T07 Copyright IBM Corp. 2016                                 *
//* All rights reserved                                               *
//* US Government users restricted rights  -  Use, duplication or     *
//* disclosure restricted by GSA ADP schedule contract with IBM Corp. *
//*                                                                   *
//*                                                                   *
//* This JCL will allocate target libraries for z/OS Automated Unit   *
//* Testing Framework (zUnit) of IBM Z Open Unit Test          *
//*                                                                   *
//*                                                                   *
...
//*--------
//COBOL    PROC
//SOURCE   EXEC PROC=PDSE,LLQ=&UHLQ..COBOL.SOURCE.COBOL    * program
//COPYLIB  EXEC PROC=PDSE,LLQ=&UHLQ..COBOL.COPYLIB
//OBJECT   EXEC PROC=PDSE,LLQ=&UHLQ..COBOL.OBJ
//LISTING  EXEC PROC=PDSE,LLQ=&UHLQ..COBOL.LISTING,RECF=FBA,RECL=133
//SYSDEBUG EXEC PROC=PDSE,LLQ=&UHLQ..COBOL.SYSDEBUG,RECL=1024
//*ZUNIT    EXEC PROC=PDSE,LLQ=&UHLQ.ZUNIT.COBOL           * test case
//         PEND
//*--------
//PLI      PROC
...
//AZUCFG   EXEC PROC=PDSE,LLQ=ZUNIT.BZUCFG,RECF=VBA,RECL=16383
//* zUnit test case generation configuration
//AZUGEN   EXEC PROC=PDSE,LLQ=ZUNIT.AZUGEN,RECF=VBA,RECL=16383
//* zUnit runner result
//AZURES   EXEC PROC=PDSE,LLQ=ZUNIT.BZURES,RECF=VBA,RECL=16383
...
//            UNIT=SYSALLDA,
//*           VOL=SER=&VOLSER,
//            DSN=IBMUSER.ZUNIT.DLAYDBG.EQAUOPTS
//         PEND
//*--------
//*
